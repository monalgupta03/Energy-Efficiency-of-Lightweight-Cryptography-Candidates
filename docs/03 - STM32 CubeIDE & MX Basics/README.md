...
## 
### PA5?
STM Pins are grouped into ports (GPIOA -> Port A, GPIOB -> Port B), Each port has pins (PA0, PA1...)
PA5 -> Port A, Pin 5.
//how many total ports are there?? Around 6, A to F

The onboard LED (LD2) is physically connected to PA5.

High -> 3.3V on PA5  (GPIO_PIN_SET)
...
### SysTick?
Like a built in stopwatch. The timer increments every 1 ms.
